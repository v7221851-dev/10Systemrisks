...
# Веса по factor_id (сумма = 1.0), обоснованы данными гепатологии
HEPATIC_WEIGHTS = {
    "H001": 0.19,   # АЛТ — основной маркер повреждения гепатоцитов
    "H002": 0.16,   # АСТ — повреждение печени/гепатит
    "H003": 0.15,   # Билирубин общий — функция, прогноз
    "H004": 0.10,   # Билирубин прямой — холестаз
    "H005": 0.12,   # ГГТ — желчные пути, алкоголь
    "H006": 0.08,   # Щелочная фосфатаза — холестатический паттерн
    "H007": 0.05,   # Холестерин общий — менее специфичен
    "H008": 0.06,   # Общий белок — синтетическая функция
    "H009": 0.04,   # СРБ — неспецифичное воспаление
    "H010": 0.05,   # Триглицериды — липидный обмен, NAFLD/жировой гепатоз
}
